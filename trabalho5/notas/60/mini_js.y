...
LET_VAR :  ID  {if(!insere_tabela_de_simbolos( DeclLet, $1)) $$.c = $1.c + "&";}
        ...
        | ID '=' OBJ {if(!insere_tabela_de_simbolos( DeclLet, $1 )) $$.c = $1.c + "&" + $1.c + $3.c + "=" + "^";
                      else $$.c = $1.c + $3.c + "=" + "^";}
        ;
...
E : Lvalue '=' OBJ { $$.c = limpAcesso($1.c) + "{}" + "="; verificar_variavel($1, true);} 
  ...
  | ID SETA EMPILHA_TS {insere_tabela_de_simbolos( DeclVar, $1 ); in_func++;} E 
      {
              in_func--;    
  ...
  | ID SETA EMPILHA_TS {insere_tabela_de_simbolos( DeclVar, $1 ); in_func++;} '{' CMDs '}' 
    { 
              in_func--;    
              string lbl_endereco_funcao = gera_label( "func_" + $1.c[0] );
              string definicao_lbl_endereco_funcao = ":" + lbl_endereco_funcao;
