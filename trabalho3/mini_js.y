...
AT  : ID '=' ATLinha {$$.c = $3.c + $1.c + "=" + "^";}
    | IDLs '=' ATLinha {$$.c = $1.c + $3.c + "[=]" + "^";}
    | ID '=' E {$$.c = $3.c + $1.c + "=" + "^";}
    | IDLs '=' E {$$.c = $1.c + $3.c + "[=]" + "^";}
    | ID MAIS_IGUAL E {$$.c = $1.c + "@" + $3.c + "+" + $1.c + "=" + "^";}
    | IDLs MAIS_IGUAL E  {$$.c = $1.c + "@" + $3.c + "+" + $1.c + "=" + "^";}
    | ID MAIS_MAIS {$$.c = $1.c + "@" + "1" + "+" + $1.c + "=" + "^";}
    | IDLs MAIS_MAIS {$$.c = $1.c + "@" + "1" + "+" + $1.c + "=" + "^";}


ATLinha  : ID '=' AT {$$.c = $3.c + $1.c + "=";}
    | IDLs '=' ATLinha {$$.c = $1.c + $3.c + "[=]";}
    | ID '=' E {$$.c = $3.c + $1.c + "=";}
